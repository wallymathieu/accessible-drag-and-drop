(function() {
    ...
    ko.bindingHandlers.draggable = {
        init: function(element, valueAccessor, allBindingsAccessor, data, context) {
            ...
            var targets = element.querySelectorAll('[data-draggable="target"]');
    ...
    document.addEventListener('mousedown', function(e) {
        ...
        if (e.target.getAttribute('draggable')) {
            ...
            //and the item's gra8bbed state is currently false
            if (!hasModifier(e) &&
    ...
    ko.applyBindings(data, document.getElementById('datas'));
